 ...
 * Calculates the effect of octave for the unit.
 */
void octave_effect_callback(octave_effect_tst *self){
	// TODO
}
...
/*
 * This function sets the input and output buffer pointers
 * starts the CODEC: AD1939
 * Starts the DMAs for I2S interfaces
 */
